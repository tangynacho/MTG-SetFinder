...
import { createLinkElement, defaultFactoryOptions, getLogger, processCssPromises, setLogger, wireCssLinkElement } from "./css-helpers.js";
let observer;
let autoLinkEls = [];
const projectId = '{vpss:PROJECT_ID}';
const cssInjectedDictionary = '{vpss:CSS_MAP}';
const cssMap = JSON.parse(cssInjectedDictionary);
const cssFileMap = {};
let base = import.meta.env.BASE_URL;
base += base.endsWith('/') ? '' : '/';
let autoLinksMounted = false;
export function cssLifecycleFactory(entryPoint, options) {
    const opts = {
 ...
 */
function mountCssFile(cssFileName, loadTimeout) {
    return new Promise((rslv, _rjct) => {
 ...
 */
function unmountCssFile(cssFileName) {
...
//# sourceMappingURL=multiMife-css.js.map